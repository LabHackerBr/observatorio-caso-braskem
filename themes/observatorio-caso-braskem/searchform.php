...
<form role="search" method="get" id="<?php echo esc_attr( $form_id ); ?>" class="search-form"  action="<?php echo esc_url( home_url( '/' ) ); ?>">
    <label for="<?php echo $unique_input_id; ?>" class="screen-reader-text"><?php esc_html_e( 'Pesquisar por:', 'hacklabr' ); ?></label>
    <input
        type="search"
        id="<?php echo $unique_input_id; ?>"
        class="search-field"
        placeholder="<?php esc_attr_e( 'Termo buscado...', 'hacklabr' ); ?>"
